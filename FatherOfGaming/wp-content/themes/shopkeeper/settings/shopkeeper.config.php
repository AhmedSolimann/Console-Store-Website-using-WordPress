    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields' => array(
            ...
            array (
                ...
                'subtitle' => __('<em>Display the button on hover or display it all the time.-Null24.Net</em>', 'shopkeeper'),
                // 'desc' => __('<em>When enabled, the feature Turns On the quick view functionality.</em>', 'shopkeeper'),
                'id' => 'add_to_cart_display',
                'on' => __('Display when hovering-Null24.Net', 'shopkeeper'),
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields' => array(
            ...
            array (
                ...
                'subtitle' => __('<em>Enable / Disable Sharing Options.-Null24.Net<em>', 'shopkeeper'),
                'id' => 'sharing_options',
                'on' => __('Enabled', 'shopkeeper'),
                'off' => __('Disabled', 'shopkeeper'),
                'type' => 'switch',
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields' => array(
            ...
            array(
                ...
                'subtitle'      => "<em>Body background with image, color, etc.-Null24.Net</em>",
                'default'  => array(
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields' => array(
            ...
            array (
                ...
                'subtitle' => __('<em>Type your Google+ profile URL here.-Null24.Net</em>', 'shopkeeper'),
                'id' => 'googleplus_link',
                'type' => 'text',
            ),
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields' => array(
            ...
            array (
                ...
                'subtitle' => __('<em>Paste your custom CSS code here.-Null24.Net</em>', 'shopkeeper'),
                'id' => 'custom_css',
                'type' => 'ace_editor',
                'mode' => 'css',
            ),
